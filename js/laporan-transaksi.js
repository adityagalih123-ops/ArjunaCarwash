...
function calcEditTotals() {
  ...
  return { subtotal, totalHpp, totalLaborCost, totalOperationalCost, type, value: rawValue, discountAmount, total };
}

function recalcEditTotals() {
  const { subtotal, totalLaborCost, totalOperationalCost, discountAmount, total } = calcEditTotals();
